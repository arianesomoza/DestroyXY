  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      GameView.prototype.addLivesText = function (ctx) {
        let x = this.game.DIM_X * 0.87,
          y = this.game.DIM_Y * 0.05;
      ...
      GameView.prototype.addMenu = function (ctx) {
        let x = this.game.DIM_X * 0.5,
          y = this.game.DIM_Y * 0.1;
      };

      GameView.prototype.addScoreText = function (ctx) {
        let x = this.game.DIM_X * 0.01,
          y = this.game.DIM_Y * 0.05;
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      Game.prototype.addShields = function () {
        for (let i = 0, x = 0.05; i < 5; i++, x += 0.2) {
          let shieldPosX = this.canvasSize[0] * x + 14;
          let shieldPosY = this.canvasSize[1] * 0.8;
      ...
      Game.prototype.addDefenderShip = function () {
        const defender = new Ship({
          ...
          radius: 16,
          pos: [(this.canvasSize[0] - 30) * 0.52, this.canvasSize[1] - 70],
          vel: [0, 0],
          side: "defender",
        });
      ...
      // fuego enemigo pium pium
      Game.prototype.enemyFire = function () {
        // más fuego, más muerte
        let fireChance,
          invaderCount = this.invaderShips.length;
        if (invaderCount < 10) {
          fireChance = 500;
      ...
      Ship.prototype.removeShip = function (shipToRemove) {
        this.game.invaderShips.forEach((ship) => {
          if (ship.id === shipToRemove.id) {
            this.game.invaderShips = this.game.invaderShips.filter(
              (s) => s.id !== shipToRemove.id
            );
          }
        });
      };
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      Bullet.prototype.draw = function (ctx) {
        ...
        ctx.fillRect(this.pos[0], this.pos[1], 4, 14);
      };
